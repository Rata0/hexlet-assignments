...
public class AppTest {
    ...
    void testCreatePerson() throws Exception {
        ...
        assertThat(response.getContentAsString()).contains("John", "Smith", "Jack", "Doe", "Jassica", "Simpson",
            "Robert", "Lock");
    }
    ...
    @Test
    void testShowPeople() throws Exception {
        MockHttpServletResponse responsePost = mockMvc
                .perform(
                        get("/people/{id}", 3)
                                .contentType(MediaType.APPLICATION_JSON)
    ...
    void testUpdatePeople() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(response.getContentAsString()).contains("Alexander");
    }
